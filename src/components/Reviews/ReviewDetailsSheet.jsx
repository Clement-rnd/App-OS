...
// Matches the CSS transition duration on .review-details-sheet__content.
  ...
  return (
    <div className={`review-details-overlay${isClosing ? ' review-details-overlay--closing' : ''}`}>
      ...
      >
        ...
        <div
          className={`review-details-sheet__content${isContentExiting ? ' review-details-sheet__content--exiting' : ''}`}
        >
